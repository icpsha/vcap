...
keep a loose eye on it.
     ...
     bash < <(curl -s -k -B https://raw.github.com/engindog/vcap/master/setup/install)
...
installer will be removed from the source tree.
     ...
     sudo apt-get install curl
     bash < <(curl -s -k -B https://raw.github.com/engindog/vcap/master/dev_setup/bin/vcap_dev_setup)
